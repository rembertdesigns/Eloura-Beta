      ...
      <div className="container mx-auto px-4 py-12 md:py-16 lg:py-12 max-w-7xl flex-1 flex flex-col justify-center">
        ...
        <div className="mb-6">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-4 gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <Button onClick={() => setShowMoodPopup(true)} variant="outline" className="flex items-center gap-2 border-orange-200 hover:bg-orange-50 hover:border-orange-300 transition-all duration-300 hover:scale-105 group min-h-[48px] px-6">
        ...
        <div className="flex justify-center mb-8">
          <div className={`grid grid-cols-1 md:grid-cols-4 gap-4 w-full max-w-5xl transition-all duration-700 ${isLoaded ? 'animate-scale-in' : 'opacity-0 scale-95'}`}>
            ...
            <Card className={`cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-2xl ${activeFilter === 'village' ? 'ring-2 ring-green-500 bg-green-100 shadow-xl' : 'bg-green-50 hover:bg-green-100 shadow-lg'} border-green-200 h-32`} onClick={() => handleStatusCardClick('village')}>
              <CardContent className="p-6 text-center h-full flex flex-col justify-center">
                <div className="flex items-center justify-center mb-3">
            ...
            <Card className={`cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-2xl ${activeFilter === 'goals' ? 'ring-2 ring-purple-500 bg-purple-100 shadow-xl' : 'bg-purple-50 hover:bg-purple-100 shadow-lg'} border-purple-200 h-32`} onClick={() => handleStatusCardClick('goals')}>
              <CardContent className="p-6 text-center h-full flex flex-col justify-center">
                <div className="flex items-center justify-center mb-3">
