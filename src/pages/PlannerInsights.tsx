...
const PlannerInsights = () => {
  ...
  const insights = [{
    type: "warning",
    text: "Weekends are 40% more overloaded than weekdays",
    action: "Shift 2 errands to weekdays"
  }, {
    type: "success",
    text: "Tuesday mornings flow smoothly when nurse visits",
    action: "Keep this pattern"
  }, {
    type: "info",
    text: "Dad's mood improves on days with outdoor activities",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="card-warm">
            ...
            <CardContent className="space-y-4">
              {Object.entries(timeTracking).map(([category, data]) => <div key={category} className="space-y-2">
          ...
          <Card className="card-warm">
            ...
            <CardContent className="space-y-4">
              {insights.map((insight, index) => <div key={index} className="p-3 border border-white/50 rounded-lg space-y-2 bg-white/40">
