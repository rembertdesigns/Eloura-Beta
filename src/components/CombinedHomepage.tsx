        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="p-8 text-center bg-white/80 backdrop-blur-sm border-[#E1CFE3]/30 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                <div className="mb-6 flex justify-center gap-3">
                  <div className="w-16 h-16 bg-[#D7642A] rounded-full"></div>
            ...
            <Card className="p-8 text-center bg-white/80 backdrop-blur-sm border-[#E1CFE3]/30 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                <div className="mb-6 flex justify-center gap-3">
                  <div className="w-16 h-16 bg-[#FCC931] rounded-full"></div>
                  <div className="w-16 h-16 bg-[#E1CFE3] rounded-full"></div>
                </div>
            ...
            <Card className="p-8 text-center bg-white/80 backdrop-blur-sm border-[#E1CFE3]/30 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                <div className="mb-6 flex justify-center gap-2">
                  <div className="w-12 h-12 bg-[#223B0A] rounded-full"></div>
