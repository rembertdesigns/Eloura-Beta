...
import { Plus, Upload, X, Heart } from 'lucide-react';
import { useToolkitItems, type ToolkitItem } from '@/hooks/useToolkitItems';

const EldercareModal: React.FC = () => {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          <div>
            <Input
              placeholder="e.g., Medication Schedule, Care Instructions"
              value={title}
          ...
          <div>
            <Textarea
              placeholder="Medical routines, care notes, important instructions..."
              rows={4}
              value={content}
          ...
          <div>
            <Select value={itemType} onValueChange={(value: ToolkitItem['item_type']) => setItemType(value)}>
              ...
              <SelectContent>
                ...
                <SelectItem value="contacts">Healthcare Contacts</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div>
            <div className="flex items-center gap-2">
              <Button variant="outline" size="sm" asChild>
                <label htmlFor="eldercare-file-upload" className="cursor-pointer">
                  <Upload className="h-3 w-3 mr-1" />
                  Upload Files
                </label>
              </Button>
              <input
                id="eldercare-file-upload"
                type="file"
                multiple
